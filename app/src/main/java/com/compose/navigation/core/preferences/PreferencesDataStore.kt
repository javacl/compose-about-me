package com.compose.navigation.core.preferences
...
class PreferencesDataStore constructor(
    ...
    private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "about.me.preferences.data.store")
