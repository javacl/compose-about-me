package compose.about.me.core.preferences
...
class PreferencesDataStore constructor(
    ...
    private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "compose.about.me.preferences.data.store")
